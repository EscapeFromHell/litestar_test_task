...
@post("/", status_code=201, dependencies={"uow": Provide(UnitOfWork)})
...
@delete("/{user_id:int}", status_code=200, dependencies={"uow": Provide(UnitOfWork)})
